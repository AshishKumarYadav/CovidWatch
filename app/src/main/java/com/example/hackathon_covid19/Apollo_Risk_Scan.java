...
public class Apollo_Risk_Scan extends BaseNavigationActivity implements BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // https://bit.ly/2WylPf9
        ...
        {
            webView.loadUrl("https://bit.ly/2WylPf9");
        }
        else
        {
    ...
    {
        Intent intent = new Intent(Apollo_Risk_Scan.this,CardActivity.class);
